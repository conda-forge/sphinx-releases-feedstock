...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-releases-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3561&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-releases-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-releases` can be installed with:

```
conda install sphinx-releases
```

It is possible to list all of the versions of `sphinx-releases` available on your platform with:
